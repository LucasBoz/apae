(function (window, angular, undefined) {
    ...
    //Start the AngularJS
    var module = angular.module('home', ['ngMessages', 'ngSanitize', 'ngMaterial', 'ui.router', 'eits-md', 'eits.controls.paper-sheet1', 'md.data.table', 'eits-ng']);
    ...
    module.config(
        function ($stateProvider, $urlRouterProvider, $importServiceProvider, $translateProvider, $mdThemingProvider, $mdDateLocaleProvider) {
             ...
             */
                ...
                .state('tecnico', {
                    url: "/",
                    templateUrl: './modules/home/views/tecnico/tecnico-index.html',
                    controller: 'TecnicoController',
                    abstract: true
                })
                .state('tecnico.list', {
                    url: "tecnico",
                    templateUrl: './modules/home/views/tecnico/tecnico-list.html'
                })
                .state('tecnico.new', {
                    url: "novo",
                    templateUrl: './modules/home/views/tecnico/tecnico-new.html'
                })
                ...
                .state('professor', {
                    url: "/",
                    templateUrl: './modules/home/views/professor/professor-index.html',
                    controller: 'ProfessorController',
                    abstract: true
                })
                .state('professor.list', {
                    url: "professor",
                    templateUrl: './modules/home/views/professor/professor-list.html'
                })
                .state('professor.new', {
                    url: "novo",
                    templateUrl: './modules/home/views/professor/professor-new.html'
                });
