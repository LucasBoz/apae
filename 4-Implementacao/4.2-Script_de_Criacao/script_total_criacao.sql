...
--
-- TOC entry 199 (class 1259 OID 96684)
-- Name: aluno_cid_audited; Type: TABLE; Schema: auditing; Owner: postgres
--

CREATE TABLE aluno_cid_audited (
    id bigint NOT NULL,
...
ALTER TABLE aluno_cid_audited OWNER TO postgres;

--
-- TOC entry 200 (class 1259 OID 96689)
-- Name: aluno_deficiencia_audited; Type: TABLE; Schema: auditing; Owner: postgres
--

CREATE TABLE aluno_deficiencia_audited (
    id bigint NOT NULL,
    revision bigint NOT NULL,
    revision_type smallint,
    deficiencia integer,
...
ALTER TABLE aluno_deficiencia_audited OWNER TO postgres;
...
--
-- TOC entry 203 (class 1259 OID 96704)
-- Name: cid10_audited; Type: TABLE; Schema: auditing; Owner: postgres
--

CREATE TABLE cid10_audited (
    id bigint NOT NULL,
    revision bigint NOT NULL,
    revision_type smallint,
    ativo boolean,
    cat character varying(100),
    cid10 character varying(100),
    definicao character varying(100),
    descr character varying(50),
    restsexo character varying(10),
    subcat character varying(100)
);


ALTER TABLE cid10_audited OWNER TO postgres;
...
--
-- TOC entry 218 (class 1259 OID 96782)
-- Name: transporte_audited; Type: TABLE; Schema: auditing; Owner: postgres
--

CREATE TABLE transporte_audited (
    id bigint NOT NULL,
    revision bigint NOT NULL,
    revision_type smallint,
    nome character varying(100),
    tipo_transporte integer,
    comissario_id bigint,
    motorista_id bigint
);


ALTER TABLE transporte_audited OWNER TO postgres;

--
-- TOC entry 186 (class 1259 OID 96624)
-- Name: user_audited; Type: TABLE; Schema: auditing; Owner: postgres
--
...
ALTER TABLE user_audited OWNER TO postgres;
...
--
-- TOC entry 194 (class 1259 OID 96662)
-- Name: aluno_cid; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE aluno_cid (
    id bigint NOT NULL,
...
ALTER TABLE aluno_cid OWNER TO postgres;

--
-- TOC entry 193 (class 1259 OID 96660)
-- Name: aluno_cid_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE aluno_cid_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE aluno_cid_id_seq OWNER TO postgres;

--
-- TOC entry 2477 (class 0 OID 0)
-- Dependencies: 193
-- Name: aluno_cid_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE aluno_cid_id_seq OWNED BY aluno_cid.id;
...
--
-- TOC entry 190 (class 1259 OID 96646)
-- Name: cid10; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE cid10 OWNER TO postgres;

--
-- TOC entry 189 (class 1259 OID 96644)
-- Name: cid10_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE cid10_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE cid10_id_seq OWNER TO postgres;

--
-- TOC entry 2481 (class 0 OID 0)
-- Dependencies: 189
-- Name: cid10_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE cid10_id_seq OWNED BY cid10.id;
...
--
-- TOC entry 192 (class 1259 OID 96654)
...
--
-- TOC entry 191 (class 1259 OID 96652)
-- Name: transporte_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE transporte_id_seq OWNER TO postgres;

--
-- TOC entry 2491 (class 0 OID 0)
-- Dependencies: 191
-- Name: transporte_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 188 (class 1259 OID 96636)
...
--
-- TOC entry 187 (class 1259 OID 96634)
...
ALTER TABLE ONLY aluno_cid ALTER COLUMN id SET DEFAULT nextval('aluno_cid_id_seq'::regclass);
...
ALTER TABLE ONLY cid10 ALTER COLUMN id SET DEFAULT nextval('cid10_id_seq'::regclass);
...
--
-- TOC entry 2241 (class 2606 OID 96688)
-- Name: aluno_cid_audited_pkey; Type: CONSTRAINT; Schema: auditing; Owner: postgres
--

ALTER TABLE ONLY aluno_cid_audited
    ADD CONSTRAINT aluno_cid_audited_pkey PRIMARY KEY (id, revision);
...
--
-- TOC entry 2249 (class 2606 OID 96708)
-- Name: cid10_audited_pkey; Type: CONSTRAINT; Schema: auditing; Owner: postgres
--

ALTER TABLE ONLY cid10_audited
    ADD CONSTRAINT cid10_audited_pkey PRIMARY KEY (id, revision);
...
--
-- TOC entry 2279 (class 2606 OID 96786)
-- Name: transporte_audited_pkey; Type: CONSTRAINT; Schema: auditing; Owner: postgres
--

ALTER TABLE ONLY transporte_audited
    ADD CONSTRAINT transporte_audited_pkey PRIMARY KEY (id, revision);


--
-- TOC entry 2225 (class 2606 OID 96628)
-- Name: user_audited_pkey; Type: CONSTRAINT; Schema: auditing; Owner: postgres
--
...
--
-- TOC entry 2235 (class 2606 OID 96667)
-- Name: aluno_cid_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY aluno_cid
    ADD CONSTRAINT aluno_cid_pkey PRIMARY KEY (id);
...
--
-- TOC entry 2231 (class 2606 OID 96651)
-- Name: cid10_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2233 (class 2606 OID 96659)
...
--
-- TOC entry 2227 (class 2606 OID 96643)
-- Name: uk_user_login; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2229 (class 2606 OID 96641)
...
--
-- TOC entry 2318 (class 2606 OID 96928)
-- Name: fk_aluno_cid_audited_revision; Type: FK CONSTRAINT; Schema: auditing; Owner: postgres
--

ALTER TABLE ONLY aluno_cid_audited
    ADD CONSTRAINT fk_aluno_cid_audited_revision FOREIGN KEY (revision) REFERENCES revision(id);
...
--
-- TOC entry 2322 (class 2606 OID 96948)
-- Name: fk_cid10_audited_revision; Type: FK CONSTRAINT; Schema: auditing; Owner: postgres
--

ALTER TABLE ONLY cid10_audited
    ADD CONSTRAINT fk_cid10_audited_revision FOREIGN KEY (revision) REFERENCES revision(id);
...
--
-- TOC entry 2337 (class 2606 OID 97023)
-- Name: fk_transporte_audited_revision; Type: FK CONSTRAINT; Schema: auditing; Owner: postgres
--

ALTER TABLE ONLY transporte_audited
    ADD CONSTRAINT fk_transporte_audited_revision FOREIGN KEY (revision) REFERENCES revision(id);


--
-- TOC entry 2312 (class 2606 OID 96629)
...
--
-- TOC entry 2315 (class 2606 OID 96913)
-- Name: fk_aluno_cid_aluno_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY aluno_cid
    ADD CONSTRAINT fk_aluno_cid_aluno_id FOREIGN KEY (aluno_id) REFERENCES pessoa(id);


--
-- TOC entry 2316 (class 2606 OID 96918)
-- Name: fk_aluno_cid_cid_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY aluno_cid
    ADD CONSTRAINT fk_aluno_cid_cid_id FOREIGN KEY (cid_id) REFERENCES cid10(id);
...
--
-- TOC entry 2345 (class 2606 OID 97063)
-- Name: fk_pessoa_transporte_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY pessoa
    ADD CONSTRAINT fk_pessoa_transporte_id FOREIGN KEY (transporte_id) REFERENCES transporte(id);
...
--
-- TOC entry 2313 (class 2606 OID 96903)
-- Name: fk_transporte_comissario_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY transporte
    ADD CONSTRAINT fk_transporte_comissario_id FOREIGN KEY (comissario_id) REFERENCES pessoa(id);


--
-- TOC entry 2314 (class 2606 OID 96908)
-- Name: fk_transporte_motorista_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY transporte
    ADD CONSTRAINT fk_transporte_motorista_id FOREIGN KEY (motorista_id) REFERENCES pessoa(id);
